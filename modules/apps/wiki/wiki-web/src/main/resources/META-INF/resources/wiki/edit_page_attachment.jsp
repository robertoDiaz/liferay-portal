	...
	uploader.on(
		...
		function(event) {
			...
			if (searchContainer) {
				...
				rowColumns.push('<a class="delete-attachment" data-fileName="' + event.name + '" data-rowId="' + event.id + '" href="javascript:;"><%= trashHelper.isTrashEnabled(scopeGroupId) ? UnicodeLanguageUtil.get(resourceBundle, "move-to-recycle-bin") : UnicodeFormatter.toString(removeAttachmentIcon) %></a>');
