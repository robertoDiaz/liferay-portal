...
public class KBFolderFinderImpl
	...
	public static final String COUNT_A_F_ByG_P =
		KBFolderFinder.class.getName() + ".count_A_F_ByG_P";
	public static final String FIND_A_F_By_G_P =
		KBFolderFinder.class.getName() + ".find_A_F_ByG_P";
	...
	public int countF_A_ByG_P(
		...
		try {
			...
			sb.append(
				CustomSQLUtil.get(
					getClass(), COUNT_A_F_ByG_P, queryDefinition));
	...
	public List<Object> findF_A_ByG_P(
		...
		try {
			...
			String sql = CustomSQLUtil.get(
				getClass(), FIND_A_F_By_G_P, queryDefinition);
