 ...
 * @author Roberto Díaz
 */
public class KBModelTitleComparator<T> extends OrderByComparator<T> {
	...
	public KBModelTitleComparator() {
		this(false, false);
	}

	public KBModelTitleComparator(boolean ascending) {
		this(ascending, false);
	}

	public KBModelTitleComparator(boolean ascending, boolean orderByModel) {
