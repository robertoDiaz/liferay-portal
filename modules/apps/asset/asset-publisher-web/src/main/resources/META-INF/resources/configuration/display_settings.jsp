...
<aui:input helpMessage='<%= LanguageUtil.format(request, "number-of-items-to-display-help", SearchContainer.MAX_DELTA, false) %>' label="number-of-items-to-display" name="preferences--delta--" type="text" value="<%= assetPublisherDisplayContext.getDelta() %>">
