 ...
 * @author Roberto Díaz
 */
public class LiferayGenConfigUtil {

	public static Map<String, Object> getConfiguration(String configurationText)
		throws Exception {
	...
	private static Locale[] _getLocales(String localesString) {
		...
		if (Validator.isNull(localesString) || "all".equals(localesString)) {
			...
			if ((availableLocales != null) &&
				...
				randomLength = ValueGenerator.getRandomIntegerFromRange(
