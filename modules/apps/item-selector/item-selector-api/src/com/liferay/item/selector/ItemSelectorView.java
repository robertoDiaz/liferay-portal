...
public interface ItemSelectorView<T extends ItemSelectorCriterion> {
	...
	/**
	 * Returns the ItemSelectorCriterion class. This method is a
	 * way to declare that this class belongs to a ItemSelectorCriterion.
	 *
	...
	/**
	 * Returns a List of the ReturnTypes that the view could return.
	 *
	...
	/**
	 * Returns the title of the view. This is used by the framework to show the
	 * tab pill.
	 *
