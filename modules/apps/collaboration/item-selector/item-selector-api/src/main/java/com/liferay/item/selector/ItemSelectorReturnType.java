 ...
 * if they are compatibles, using the {@link com.liferay.item.selector.ItemSelectorCriterion}.
 *
 * The client sets in each {@link com.liferay.item.selector.ItemSelectorCriterion}
 * a list of the desired {@link com.liferay.item.selector.ItemSelectorReturnType},
 * and each {@link com.liferay.item.selector.ItemSelectorView} declares a list of
 ...
 * is shown or not in the Item Selector popup, the desired {@link com.liferay.item.selector.ItemSelectorReturnType}
