...
public class DLAppServiceUtil {
	...
	*/
	public static java.util.List<com.liferay.portal.kernel.repository.model.RepositoryEntry> getRepositoryEntries(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getRepositoryEntries(repositoryId, folderId, status,
			includeMountFolders, start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.portal.kernel.repository.model.RepositoryEntry> getRepositoryEntries(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getRepositoryEntries(repositoryId, folderId, status, start,
			end);
	}
	...
	*/
	public static int getRepositoryEntriesCount(long repositoryId,
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getRepositoryEntriesCount(repositoryId, folderId, status);
	}
