...
public class SiteMembershipPolicyMembershipsTest
	...
	@Test
	public void testaddGroupLaunchVerification() throws Exception {
	...
	@Test
	public void testAddUsersToRequiredSiteLaunchPropagation() throws Exception {
		addUsers();
		addRequiredSites();
	...
	public void testCountGroupUsersWhenAddRequiredSitesToUser()
		...
		int expectedUsersInFirstRequiredGroupCount =
			UserLocalServiceUtil.getGroupUsersCount(
				getRequiredSiteIds()[0]) + addNewUser(1);

		int expectedUsersInSecondRequiredGroupCount =
			UserLocalServiceUtil.getGroupUsersCount(
				getRequiredSiteIds()[1]) + addNewUser(1);
	...
	public void testCountGroupUsersWhenAddUsersToRequiredSite()
		...
		int expectedUserGroupCountInRequiredSite =
			UserLocalServiceUtil.getGroupUsersCount(
				getRequiredSiteIds()[0]) + addNewUser(2);
	...
	@Test
	public void testCreateUserWithRequiredSitesLaunchPropagation()
		throws Exception {
	...
	public void testExceptionThrowingWhenAddForbiddenSitesToUser()
		throws Exception {
	...
	@Test(expected = MembershipPolicyException.class)
	public void testExceptionThrowingWhenAddUserToForbiddenSite()
		throws Exception {
	...
	@Test(expected = MembershipPolicyException.class)
	public void testExceptionThrowingWhenCreatingUserWithForbiddenSites()
		throws Exception {
	...
	@Test(expected = MembershipPolicyException.class)
	public void testExceptionThrowingWhenRemoveUsersFromRequiredSite()
		throws Exception {
	...
	public void testSuccessfulUnsetGroupUsersWhenRemoveUserFromStandardSite()
		...
		int expectedGroupUsersInStandardSite1 =
			UserLocalServiceUtil.getGroupUsersCount(
		...
		int currentUserGroupCount1 = UserLocalServiceUtil.getGroupUsersCount(
			getStandardSiteIds()[0]);

		Assert.assertEquals(
			expectedGroupUsersInStandardSite1, currentUserGroupCount1);
		Assert.assertTrue(getPropagateMembershipMethodFlag());
	}

	@Test
	public void testSuccessfulUserUpdateWhenAddRequiredSiteToUser()
		throws Exception {

		addUsers();
		addRequiredSites();

		int expectedRequiredGroupUserCount =
			UserLocalServiceUtil.getGroupUsersCount(
				getRequiredSiteIds()[0]) + addNewUser(1);
		...
		int currentRequiredGroupUserCount =
			UserLocalServiceUtil.getGroupUsersCount(getRequiredSiteIds()[0]);

		Assert.assertEquals(
			expectedRequiredGroupUserCount, currentRequiredGroupUserCount);

		Assert.assertTrue(getPropagateMembershipMethodFlag());
	}

	@Test
	public void testSuccessfulUserUpdateWhenDeleteStandardSitesFromUser()
		throws Exception {
		...
		long[] siteIds = ArrayUtil.append(
			getStandardSiteIds(), getRequiredSiteIds());

		User user = UserLocalServiceUtil.getUser(getUserIds()[0]);

		MembershipPolicyTestUtil.updateUser(
			user, null, null, siteIds, null,
			Collections.<UserGroupRole>emptyList());
