...
import com.liferay.portal.model.NotificationConstants;
...
public class BlogsUserNotificationHandler extends BaseUserNotificationHandler {
	...
	protected String getBody(
		...
		if (notificationType == NotificationConstants.TYPE_ADD_ENTRY) {
			title = "x-wrote-a-new-blog-entry";
		}
		else if (notificationType == NotificationConstants.TYPE_UPDATE_ENTRY) {
