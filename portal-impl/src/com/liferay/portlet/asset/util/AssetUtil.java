...
public class AssetUtil {
	...
	protected static Sort[] getSorts(AssetEntryQuery assetEntryQuery) {
		Sort sort1 = new Sort(
			assetEntryQuery.getOrderByCol1(), Sort.STRING_TYPE,
			!assetEntryQuery.getOrderByType1().equalsIgnoreCase("asc"));

		Sort sort2 = new Sort(
			assetEntryQuery.getOrderByCol2(), Sort.STRING_TYPE,
			!assetEntryQuery.getOrderByType2().equalsIgnoreCase("asc"));
